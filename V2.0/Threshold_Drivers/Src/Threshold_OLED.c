...
void OLED_Write_String_Large(unsigned char x,unsigned char y,unsigned char *s)
{
    ...
    for (i=0; s[i]!='\0'; i++)
    {
        OLED_Write_Char_Large(x + i, y, s[i]);
    }
} 
...
{
    OLED_Write_Char_Large(x,     y, num / 10);
    OLED_Write_Char_Large(x + 1, y, num % 10);
} 
...
{
    OLED_Write_Char_Large(x,     y, num / 100);
    OLED_Write_Char_Large(x + 1, y, num % 100 / 10);
    OLED_Write_Char_Large(x + 2, y, num % 10);
} 
...
{
    OLED_Write_Char_Large(x,     y, num / 1000);
    OLED_Write_Char_Large(x + 1, y, num % 1000 / 100);
    OLED_Write_Char_Large(x + 2, y, num % 100 / 10);
    OLED_Write_Char_Large(x + 3, y, num % 10);
}
...
void OLED_Write_Num5_Large(unsigned char x,unsigned char y,uint32_t num)
{
    OLED_Write_Char_Large(x,     y, num / 10000);
    OLED_Write_Char_Large(x + 1, y, num % 10000 / 1000);
    OLED_Write_Char_Large(x + 2, y, num % 1000 / 100);
    OLED_Write_Char_Large(x + 3, y, num % 100 / 10);
	OLED_Write_Char_Large(x + 4, y, num % 10);
}
