...
//        MMA9553_test_xyzraw\kl25_sc_rev10\klxx-sc-baremetal\src\projects\FRDM_KL25ZDemo\angle_calculation\sqrt16.c
//    Command line =  
//        "C:\Users\B51443\Desktop\KL25
//        MMA9553_test_xyzraw\kl25_sc_rev10\klxx-sc-baremetal\src\projects\FRDM_KL25ZDemo\angle_calculation\sqrt16.c"
...
//    List file    =  
//        C:\Users\B51443\Desktop\KL25
//        MMA9553_test_xyzraw\kl25_sc_rev10\klxx-sc-baremetal\build\iar\FRDM_KL25ZDemo\FLASH_128KB\List\sqrt16.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\Users\B51443\Desktop\KL25 MMA9553_test_xyzraw\kl25_sc_rev10\klxx-sc-baremetal\src\projects\FRDM_KL25ZDemo\angle_calculation\sqrt16.c
//    1 /**
//    2  * \brief  Calculates the square root of the value
//    3  * \author  Luis Puebla
//    4  * \param   value
//    5  * \return  (unsigend long)square root
//    6  * \todo    
//    7  * \warning
//    8  */   
        ...
        THUMB
//    9 unsigned int sqrt_16(unsigned int value)
//   10   {
sqrt_16:
        PUSH     {R4-R7,LR}
        MOVS     R4,R0
//   11   unsigned char num_iter=0;
        MOVS     R7,#+0
//   12   unsigned long result = 1000;
        MOVS     R6,#+250
        LSLS     R6,R6,#+2        ;; #+1000
//   13   unsigned long last_result = 1000;
        MOVS     R5,#+250
        LSLS     R5,R5,#+2        ;; #+1000
//   14    do
//   15     {
//   16      last_result = result;
??sqrt_16_0:
        MOVS     R5,R6
//   17      result = (result + value/result)/2;
        MOVS     R0,R4
        MOVS     R1,R6
        BL       __aeabi_uidiv
        ADDS     R0,R6,R0
        ...
        LSRS     R6,R6,#+1
//   18     }
//   19    while (num_iter++<7 && last_result!= result);
        MOVS     R0,R7
        MOVS     R7,R0
        ADDS     R7,R7,#+1
        UXTB     R0,R0
