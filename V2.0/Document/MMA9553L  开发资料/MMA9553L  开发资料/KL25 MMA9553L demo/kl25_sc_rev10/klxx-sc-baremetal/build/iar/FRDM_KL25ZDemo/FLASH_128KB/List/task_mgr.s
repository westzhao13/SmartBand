...
//        MMA9553_test_xyzraw\kl25_sc_rev10\klxx-sc-baremetal\src\projects\FRDM_KL25ZDemo\task_mgr\task_mgr.c
//    Command line =  
//        "C:\Users\B51443\Desktop\KL25
//        MMA9553_test_xyzraw\kl25_sc_rev10\klxx-sc-baremetal\src\projects\FRDM_KL25ZDemo\task_mgr\task_mgr.c"
...
//    List file    =  
//        C:\Users\B51443\Desktop\KL25
//        MMA9553_test_xyzraw\kl25_sc_rev10\klxx-sc-baremetal\build\iar\FRDM_KL25ZDemo\FLASH_128KB\List\task_mgr.s
//
///////////////////////////////////////////////////////////////////////////////

        #define SHT_PROGBITS 0x1

        PUBLIC ptr_next_task
        PUBLIC resp_ptr_next_task

// C:\Users\B51443\Desktop\KL25 MMA9553_test_xyzraw\kl25_sc_rev10\klxx-sc-baremetal\src\projects\FRDM_KL25ZDemo\task_mgr\task_mgr.c
//    1 /**
//    2   Copyright (c) 2006 Freescale Semiconductor
//    3   Freescale Confidential Proprietary
//    4   \file     	task_mgr.h
//    5   \brief    	Task manger for Electricity Meter Fuctions menu
...
//   20 void (*ptr_next_task)(void);       /* pointer to function */
ptr_next_task:
        DS8 4

        SECTION `.bss`:DATA:REORDER:NOROOT(2)
//   21 void (*resp_ptr_next_task)(void);  /* back for pointer function*/
resp_ptr_next_task:
        DS8 4
        ...
        END
//   22 
//   23 #define next_task(funcion) ptr_next_task = funcion 
//   24 #define next_task_t(funcion,time) ptr_next_task = funcion, ti_task=time
//   25 
//   26 /*
//   27   This task manager must be called in main() function as
//   28   
//   29    ptr_next_task();
//   30 
//   31 */
